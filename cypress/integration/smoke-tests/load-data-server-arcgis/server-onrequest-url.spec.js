...
describe('Add ARCGIS server', function() {
  before('Login', function() {
    ...
    // *********** START TEST CODE ***********
    // CYPRESS INDICATES DUMMY RESPONSE USED (CLICK REQUEST IN LOG AND VIEW CONSOLE OUTPUT),
    // BROWSER TOOLS AGREE.  SECOND REQUEST NEVER SENT.
    // CYPRESS INDICATES /GETFEATURELIST URL USED, BUT BROWSER TOOLS INDICATE ONLY /QUERY WAS USED.
    cy.server({
